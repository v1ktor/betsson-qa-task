...
export class InventoryPageSelectors {
  ...
  constructor(page: Page) {
    ...
    this.buttonAddToCartBikeLight = page.locator(
      "button[data-test='add-to-cart-sauce-labs-bike-light']",
    );
    this.buttonAddToCartBoltTShirt = page.locator(
      "button[data-test='add-to-cart-sauce-labs-bolt-t-shirt']",
    );
    this.buttonAddToCartFleeceJacket = page.locator(
      "button[data-test='add-to-cart-sauce-labs-fleece-jacket']",
    );
    this.buttonAddToCartOnesie = page.locator(
      "button[data-test='add-to-cart-sauce-labs-onesie']",
    );
    this.buttonAddToCartTShirtRed = page.locator(
